...
ALIAS = {
    ...
    "call_id": ["call_id","ship_call_id","vessel_call_id","call"],
    "eta": ["eta","eta_utc","ETA","arrive_ts","start_ts"],
    "etd": ["etd","etd_utc","ETD","depart_ts","end_ts"],
    "p_req_min": ["p_req_min","P_req_min","pmin_kw","p_req_baseline_kw","nominal_shore_kw"],
    "p_req_p50": ["p_req_p50","P_req_p50","p50_kw","nominal_shore_kw"],
    "p_req_p90": ["p_req_p90","P_req_p90","p90_kw","nominal_shore_kw"],
    ...
    "cap_kw": ["cap_kw","shore_cap_kw","shore_max_kw","cap_kW","max_kw","max_kW"],
