...
#
# 持久化：
#  - 轻量把在线学习器状态落在 /mnt/data/rl_online_model.json（若不可写则仅在内存）
#
# ============================================
...
class ClosedLoopService:
    ...
    def __init__(self, rlpanel, dispatch, telemetry=None, forecast=None, reporting=None, persist_path: str = "/mnt/data/rl_online_model.json"):
