...
def build(run_id, log_name, audit_name):
    ...
    audit = {
        ...
        'limitations': [
            ...
            if config['n_step'] > 1 else 'This is standard one-step SAC; it is not a multi-step replay experiment.',
        ],
    }
...
build('shore-bess-v8-sac-pilot-20260912-seed912-c16-physicalfix-r5',
      'sac_r5_integrity_replay_20260912.txt', 'sac-standard-r5-independent-audit-20260912.json')
