...
class BusinessDeltaReward(gym.Wrapper):
    ...
    def _potential(self):
        ...
        inventory = (env._soc - env.soc_initial) * env.energy_kwh
        # Deferred shore work is an energy debt, not a saving.
        inventory -= getattr(env, "_flex_backlog_kwh", 0.0)
        return 0.4 * inventory / env.power_kw
