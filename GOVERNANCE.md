...
The project uses maintainer review for changes to algorithms, data contracts, safety boundaries and southbound execution. A pull request should state the problem, evidence, test results and provenance impact.

Changes require an approving maintainer when they affect canonical fields, reward definitions, evaluation methodology, model-promotion gates, authentication, actuator adapters or licensing. Contributors must disclose generated or third-party material and confirm redistribution rights.
