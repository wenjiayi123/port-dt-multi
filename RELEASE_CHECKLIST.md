...
- [ ] Compile, 44 unit tests and five-controller smoke test pass on a clean checkout.
...
- [ ] No generated run, model, audit, software-copyright or local environment artifact is tracked.
